 ...
 * @author FAMY
 */
public class cursosDisponibles1 extends javax.swing.JFrame {

    /**
     * Creates new form cursosDisponibles1
     */
    public cursosDisponibles1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Ingles nivel medio", "23-11-2017"},
                {"Aprenda IDIO+", "30-11-2017"},
                {"Ingles nivel 4 al 6", "15-12-2017"},
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cursosDisponibles1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cursosDisponibles1().setVisible(true);
            }
        });
    }
