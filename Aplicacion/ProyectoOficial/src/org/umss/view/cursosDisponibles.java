...
public class cursosDisponibles extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"curso de comercio internacional", "23-11-2017"},
                {"curso de formacion superior en comercio. ciclo operativo", "30-11-2017"},
                {"curso oficial de tecnico superior en comercio", "15-12-2017"},
                {"curso de FP grado superior ", "29-12-2017"},
                {"curso experto en comercio(distancia y on-line)", "19-11-2018"}
            },
            new String [] {
                "Curso", "Fecha Inicio"
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cursosDisponibles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cursosDisponibles().setVisible(true);
            }
        });
    }
